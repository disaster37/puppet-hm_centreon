...
Puppet::Type.newtype(:centreon_host_template) do
  ...
  newproperty(:snmp_community) do
    desc 'The SNMP community of the host template.'
    validate do |value|
  ...
  newproperty(:timezone) do
    desc 'The timezone of the host template.'
    validate do |value|
  ...
  newproperty(:check_command) do
    desc 'The check_command of the host template.'
    validate do |value|
  ...
  newproperty(:check_command_args, array_matching: :all) do
    desc 'The check command argument of the host template.'
  ...
  newproperty(:check_interval) do
    desc 'The check_interval of the host template.'
    validate do |value|
  ...
  newproperty(:retry_check_interval) do
    desc 'The retry_check_interval of the host template.'
    validate do |value|
  ...
  newproperty(:max_check_attempts) do
    desc 'The max_check_attempts of the host template.'
    validate do |value|
  ...
  newproperty(:check_period) do
    desc 'The check_period of the host template.'
    validate do |value|
  ...
  newproperty(:active_check) do
    desc 'The active check of the host template.'
  ...
  newproperty(:passive_check) do
    desc 'The passive check of the host template.'
  ...
  newproperty(:note_url) do
    desc 'The note url of the host template.'
    validate do |value|
  ...
  newproperty(:action_url) do
    desc 'The action url of the host template.'
    validate do |value|
  ...
  newproperty(:note) do
    desc 'The note of the host template.'
    validate do |value|
  ...
  newproperty(:icon_image) do
    desc 'The icon image of the host template.'
    validate do |value|
