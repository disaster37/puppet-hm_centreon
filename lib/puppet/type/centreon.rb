...
Puppet::Type.newtype(:centreon) do
  ...
  newparam(:url) do
    ...
    validate do |value|
      raise 'url should be a String' unless value.is_a?(String)
    end
  end
  ...
  newparam(:username) do
    ...
    validate do |value|
      raise 'username should be a String' unless value.is_a?(String)
    end
  end
  ...
  newparam(:use_proxy, parent: Puppet::Property::Boolean) do
    desc 'Use proxy'
